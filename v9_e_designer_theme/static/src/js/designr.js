$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('/v9_e_designer_theme/static/src/images/header-bg.jpg');

	$('body').append('<img class="preload-image" src="/v9_e_designer_theme/static/src/images/contact-bg.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('/v9_e_designer_theme/static/src/images/contact-bg.jpg');
		}else{
			$.backstretch('/v9_e_designer_theme/static/src/images/header-bg.jpg');
		}
	});
